...
```
npm create cloudflare@latest -- --template=cloudflare/templates/thrifters-atlas
```

A live public deployment of this template is available at [https://thrifters-atlas.templates.workers.dev](https://thrifters-atlas.templates.workers.dev)
